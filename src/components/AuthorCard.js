  ...
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    3EAEAEA] h-auto my-6 py-8 rounded-lg border-4">
      ...
      <div id="content" className="prose lg:prose-xl px-2">
        ...
        <p className="text-justify text-lg mt-2 p-3 m-2 text-gray-800">Hello,  My name is Hannah I 
        am a student, a business woman.
        ...
        <div className="p-6 max-w-full mx-auto">
            <ul className="flex justify-center items-center gap-4">
              <li className={`border border-zinc-500 rounded-lg p-4 ${isActive.active && isActive.name === "education" && 'bg-[#FF8F56]'}`}>
               <a href="#education" id="education" onClick={handleActive} className="font-roboto font-bold text-xl text-white">Education</a>
              </li>
